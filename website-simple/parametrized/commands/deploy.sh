...
VERSION="1.1"
VERSION_CODE_NAME="simple_site_single_stack"
...
if [ -f "$COMPONENT_PATH/parameters/${STACK_NAME}_${STAGE}.json" ]; then
    PARAM_FILE="$COMPONENT_PATH/${STACK_NAME}_${STAGE}.json"
else
